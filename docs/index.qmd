---
title: "An Introduction to ESEF Data"
...
```{julia}
#| label: fig-esef_country_availability_map
...
```{julia}
#| label: fig-esef_country_availability_bar
#| fig-cap: "ESEF Country Availability (Map)"
