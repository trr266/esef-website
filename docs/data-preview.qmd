...
Raw (beta) data available for inspection [here](https://trr266.github.io/esef/esef_concepts_beta.csv).
...
```{ojs}
Inputs.table(concepts_data, {sort: "frequency", reverse: true, width: {concept: 140,},}I)
```

## Profit Data from ESEF Reports

Raw (beta) data available for inspection [here](https://trr266.github.io/esef/esef_profits_beta.csv).
